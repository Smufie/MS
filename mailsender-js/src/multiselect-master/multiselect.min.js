...
Multiselect.prototype = {
	...
	_appendEvents: function () {
		...
		var onInput = function () {
			...
			if (!text || text == '') {
				m_helper.show(
					document.querySelector('#' + self._getItemListIdentifier() + ' > span')
				);
				m_helper.show(
				...
				var array = Array.prototype.filter.call(
					document.querySelectorAll('#' + self._getItemListIdentifier() + ' li span'),
					function (obj) {
	...
	_hideList: function (context, event) {
		...
		m_helper.show(
			document.getElementById(context._getItemListIdentifier()).querySelector('span')
		);
		m_helper.show(
			document.getElementById(context._getItemListIdentifier()).querySelector('hr')
		);
		m_helper.showAll(
			document.getElementById(context._getItemListIdentifier()).querySelectorAll('li')
		);
	...
	_updateText: function (context) {
		...
		if (
			activeItems.length ==
			document.getElementById(context._getItemListIdentifier()).querySelectorAll('ul li')
				.length
		) {
			val = 'All selected';
		}
